...
def read_CurrAndVolt():
    print("jestem w funckji read_CurrAndVolt")
    # if (SPI_TYPE == 'HW'):
    ...
    try:
        ...
        g.pumpIread = mcp.read_adc(6)
        g.pumpVread = mcp.read_adc(7)

            # print out the value
        print('---------------->>>wartosc zmierzonego pradu', g.pumpIread)
        print('---------------->>>wartosc zmierzonego napiecia', g.pumpVread)
