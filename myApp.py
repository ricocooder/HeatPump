...
#     g.c = read_temp()
    ...
    return render_template("index.html", t1=g.readTemp[0], to1=g.to1, t2=g.readTemp[2], to2=g.to2, 
                           t3=g.readTemp[3], to3=g.to3, t4=g.t4, to4=g.to4, t5=g.t5, to5=g.to5, t6=g.t6, to6=g.to6, tz1=g.tz1, tz2=g.tz2, tzo2=g.tzo2, image1=pick1, pump=g.BaseEfiInPercent, mainState=g.mainState)
...
#     g.BaseEfiInPercent = setOutputs(g.mainState, g.c, g.pumpEfi)
    ...
    return render_template("index.html", t1=g.readTemp[0], to1=g.to1, t2=g.readTemp[2], to2=g.to2, t3=g.readTemp[3], to3=g.to3, t4=g.t4, to4=g.to4, t5=g.t5, to5=g.to5, t6=g.t6, to6=g.to6, tz1=g.tz1, tz2=g.tz2, tzo2=g.tzo2, image1=pick1, pump=g.BaseEfiInPercent, mainState=g.mainState)
